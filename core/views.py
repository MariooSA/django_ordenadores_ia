...
def chatbot(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            #response = {'mensaje': 'This is what I have found for you:', 'Nada': False, 'laptops': [{'Marca': 'Microsoft', 'Modelo': 'Surface Laptop 6', 'Procesador': 'Intel', 'Tarjeta_grafica': 'Intel Arc Graphics', 'RAM': 'Si', 'Pulgadas': Decimal('13.50'), 'Precio': Decimal('2528.75')}, {'Marca': 'Microsoft', 'Modelo': 'Surface Laptop 6', 'Procesador': 'Intel', 'Tarjeta_grafica': 'Intel Arc Graphics', 'RAM': 'Si', 'Pulgadas': Decimal('13.50'), 'Precio': Decimal('2528.75')}, {'Marca': 'SAMSUNG', 'Modelo': 'GALAXY BOOK4 ULTRA', 'Procesador': None, 'Tarjeta_grafica': None, 'RAM': None, 'Pulgadas': None, 'Precio': Decimal('2425.46')}, {'Marca': 'Dell', 'Modelo': 'Latitude 9450 2-in-1', 'Procesador': 'Intel', 'Tarjeta_grafica': 'UHD Graphics', 'RAM': 'Si', 'Pulgadas': Decimal('14.00'), 'Precio': Decimal('2542.61')}, {'Marca': 'LG', 'Modelo': 'gram 17Z90R', 'Procesador': 'Intel', 'Tarjeta_grafica': 'RTX™ 3050 Ti', 'RAM': 'Si', 'Pulgadas': Decimal('17.00'), 'Precio': Decimal('2205.78')}, {'Marca': 'LG', 'Modelo': 'gram 17Z90R', 'Procesador': 'Intel', 'Tarjeta_grafica': 'RTX™ 3050 Ti', 'RAM': 'Si', 'Pulgadas': Decimal('17.00'), 'Precio': Decimal('2205.78')}, {'Marca': 'LG', 'Modelo': 'gram 17Z90R', 'Procesador': 'Intel', 'Tarjeta_grafica': 'RTX™ 3050 Ti', 'RAM': 'Si', 'Pulgadas': Decimal('17.00'), 'Precio': Decimal('2205.78')}, {'Marca': 'LG', 'Modelo': 'gram 17Z90R', 'Procesador': 'Intel', 'Tarjeta_grafica': 'RTX™ 3050 Ti', 'RAM': 'Si', 'Pulgadas': Decimal('17.00'), 'Precio': Decimal('2205.78')}]}
